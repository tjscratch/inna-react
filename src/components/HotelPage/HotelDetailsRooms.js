...
@withViewport
@withStyles(styles)
class HotelDetailsRooms extends React.Component {
  constructor(props) {
    super(props);
                ...
                photo ?
                  <div className="b-rooms-list-item-info__photo">
                    <RemoteImage
                      ...
                      renderFetched={({ src }) => (
                         <div className="b-rooms-list-item-info__photo-container">
                            <img src={src} className="b-rooms-list-item-info-photo" />
                         </div>
                      )}
                    />
                  </div> : null
          ...
          <div className="b-rooms-list-item__price" onClick={(e)=>this.mobileBuyClick(e, room)}>
            <div className="b-rooms-list-item-price">
              ...
              <div className="b-rooms-list-item-price__price">
                К оплате: <span className="b-rooms-list-item-price__price__value"><Price
                data={room.PackagePrice}/></span>
              </div>
            </div>
          </div>
