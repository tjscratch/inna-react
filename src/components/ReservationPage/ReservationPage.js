...
class ReservationPage extends Component {
    ...
    renderBuyProgress() {
        return (
            <WaitMsg data={{title:'Бронируем заказ', text:'Это может занять какое-то время'}}/>
        )
    }
    ...
    render() {
        ...
        if (true || data) {
            console.log('renderBuyProgress render', this.state.buyProgress)
            return (
                <section className="b-reservation-page">
                    {this.renderOverlay()}
                    {this.state.buyProgress ? this.renderBuyProgress() : null}
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="b-reservation-page__buy-block">
                            ...
                            <div className="b-reservation-page-buy-block__button">
                                <BuyBtn text="Перейти к оплате"
                                        onSubmit={handleSubmit(this.onBuyFormSubmit.bind(this))}/>
                            </div>
                        </div>
